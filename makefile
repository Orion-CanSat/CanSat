...
# Optimization:     -O3
# 
# Time of creation: 2020/11/16 12:46
#-------------------------------------------------------------------------------------------------------------------------------------------------
...
LIBS_DIR            := lib
LIBS_NAMES          := Adafruit_BME280 Adafruit_BNO055 Adafruit_GPS Adafruit_Sensor ArduCAM Crypto DRV8835 EEPROM Orion-Libraries RadioHead SD SoftwareSerial SPI Wire
CORE_BASE           := Core/teensy4


#-------------------------------------------------------------------------------------------------------------------------------------------------
# Flags
#-------------------------------------------------------------------------------------------------------------------------------------------------
FLAGS_CPU           := -mthumb -mcpu=cortex-m7 -mfloat-abi=hard -mfpu=fpv5-d16 -fsingle-precision-constant
FLAGS_OPT           := -O3
...
DEFINES             := -D__IMXRT1062__ -DTEENSYDUINO=153 -DARDUINO_TEENSY41 -DF_CPU=600000000 -DUSB_SERIAL -DLAYOUT_US_ENGLISH -DARDUINO
...
$(TARGET_ELF): $(CORE_LIB) $(LIB_OBJ) $(SRC_OBJ)
	@echo [LD]  $@
	@$(CC) $(LD_FLAGS) -o "$@" $(SRC_OBJ) $(LIB_OBJ) $(CORE_LIB)
